...
RDebugUtils.currentLine=131083;
 //BA.debugLineNum = 131083;BA.debugLine="Activity.LoadLayout(\"Main_Layout\")";
mostCurrent._activity.LoadLayout("Main_Layout",mostCurrent.activityBA);
RDebugUtils.currentLine=131084;
 //BA.debugLineNum = 131084;BA.debugLine="If (usb.HasPermission(1)) Then	' Ver_2.4";
if ((_usb.HasPermission((int) (1)))) { 
RDebugUtils.currentLine=131086;
 //BA.debugLineNum = 131086;BA.debugLine="Dim dev As Int";
_dev = 0;
RDebugUtils.currentLine=131089;
 //BA.debugLineNum = 131089;BA.debugLine="dev = usb.Open(115200, 1)		' Ver_2.4";
_dev = _usb.Open(processBA,(int) (115200),(int) (1));
RDebugUtils.currentLine=131093;
 //BA.debugLineNum = 131093;BA.debugLine="If dev <> usb.USB_NONE Then";
if (_dev!=_usb.USB_NONE) { 
RDebugUtils.currentLine=131098;
 //BA.debugLineNum = 131098;BA.debugLine="astreams.Initialize(usb.GetInputStream,usb.Get";
_astreams.Initialize(processBA,_usb.GetInputStream(),_usb.GetOutputStream(),"Astreams");
 }else {
RDebugUtils.currentLine=131100;
 //BA.debugLineNum = 131100;BA.debugLine="Log(\"Error opening USB port 1\")";
anywheresoftware.b4a.keywords.Common.Log("Error opening USB port 1");
 };
 }else {
RDebugUtils.currentLine=131103;
 //BA.debugLineNum = 131103;BA.debugLine="usb.RequestPermission(1)  ' Ver_2.4";
...
RDebugUtils.currentLine=524288;
 //BA.debugLineNum = 524288;BA.debugLine="Sub Astreams_NewData (Buffer() As Byte)";
RDebugUtils.currentLine=524289;
 //BA.debugLineNum = 524289;BA.debugLine="Dim command As String";
_command = "";
RDebugUtils.currentLine=524290;
 //BA.debugLineNum = 524290;BA.debugLine="Dim Pos_Box As Int";
_pos_box = 0;
RDebugUtils.currentLine=524291;
 //BA.debugLineNum = 524291;BA.debugLine="Dim bandera As Boolean";
_bandera = false;
RDebugUtils.currentLine=524293;
 //BA.debugLineNum = 524293;BA.debugLine="command =conv.StringFromBytes(Buffer, \"UTF8\")";
_command = _conv.StringFromBytes(_buffer,"UTF8");
RDebugUtils.currentLine=524294;
 //BA.debugLineNum = 524294;BA.debugLine="If command.Contains(\"ID0\") Then";
if (_command.contains("ID0")) { 
RDebugUtils.currentLine=524295;
 //BA.debugLineNum = 524295;BA.debugLine="Msgbox(command.IndexOf(\"ID0\"),\"999\")";
anywheresoftware.b4a.keywords.Common.Msgbox(BA.NumberToString(_command.indexOf("ID0")),"999",mostCurrent.activityBA);
RDebugUtils.currentLine=524296;
 //BA.debugLineNum = 524296;BA.debugLine="Timer_1.Text = command";
mostCurrent._timer_1.setText((Object)(_command));
 };
...
RDebugUtils.currentLine=458752;
 //BA.debugLineNum = 458752;BA.debugLine="Sub Button1_Click";
RDebugUtils.currentLine=458754;
 //BA.debugLineNum = 458754;BA.debugLine="mensaje_Out=\"a\"";
_mensaje_out = "a";
RDebugUtils.currentLine=458755;
 //BA.debugLineNum = 458755;BA.debugLine="Write_In_Arduino(mensaje_Out)";
...
RDebugUtils.currentModule="main";
if (Debug.shouldDelegate(mostCurrent.activityBA, "write_in_arduino"))
	return (String) Debug.delegate(mostCurrent.activityBA, "write_in_arduino", new Object[] {_ms});
RDebugUtils.currentLine=196608;
 //BA.debugLineNum = 196608;BA.debugLine="Sub Write_In_Arduino (Ms As String)";
RDebugUtils.currentLine=196609;
 //BA.debugLineNum = 196609;BA.debugLine="Ms = mensaje_Out";
_ms = _mensaje_out;
RDebugUtils.currentLine=196610;
 //BA.debugLineNum = 196610;BA.debugLine="astreams.Write(Ms.GetBytes(\"UTF8\"))";
...
RDebugUtils.currentLine=393216;
 //BA.debugLineNum = 393216;BA.debugLine="Sub Label_Click";
RDebugUtils.currentLine=393217;
 //BA.debugLineNum = 393217;BA.debugLine="Dim lbl_tag As Label";
_lbl_tag = new anywheresoftware.b4a.objects.LabelWrapper();
RDebugUtils.currentLine=393218;
 //BA.debugLineNum = 393218;BA.debugLine="lbl_tag = Sender";
_lbl_tag.setObject((android.widget.TextView)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA)));
RDebugUtils.currentLine=393219;
 //BA.debugLineNum = 393219;BA.debugLine="lbl_tag.Text = lbl_tag.Tag";
